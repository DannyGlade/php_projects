...
$viewQ = "SELECT * FROM `stud`";
$result = mysqli_query($con, $viewQ);
?>
<div class="contaner-fluid">
<h3 class="text-center text-primary">Student DataBase</h3>
    <div class="row">
                ...
                <table class="table table-dark table-hover table-bordered table-striped border border-secondary rounded-pill">
                    ...
                    ?>
                        <tr>
                            ...
                            <td><?php echo $addr ?></td>
                            <td><a href="update.php?getsid=<?php echo $sid ?>" class="text-success"><i class="fas fa-edit"></i></a></td>
                            <td><a href="delete.php?getsid=<?php echo $sid ?>" class="text-danger"><i class="fas fa-times"></i></a></td>
                        </tr>
                    <?php
                    }
                    ?>
