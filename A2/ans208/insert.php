...
<div class="container-fluid card w-25">
    <h4 class="card-title text-center text-primary">Student Registraion Form</h4>
...
if (isset($_POST['sub'])) {
    ...
    if (empty($fname) || empty($lname) || empty($gender) || empty($bday) || empty($pnum) || empty($email)) {
        ...
        $insertQ = " INSERT INTO `stud`( `fname`, `lname`, `gender`, `bday`, `pnum`, `email`, `addr`) VALUES ('$fname','$lname','$gender','$bday','$pnum','$email','$addr')";
